...
// Commented to prevent loading existing drawing
...
// 						|| elem && elem.tagName == "path" && !multiselected) { // This was added in r1430, but not sure why
			...
			// called when any element has changed
			var elementRemoved = function(window,elems) {
				var mode = svgCanvas.getMode();
				if(mode === "select") {
					setSelectMode();
				}
...
// 						|| elem && elem.tagName == "path" && !multiselected) { // This was added in r1430, but not sure why
				...
				svgCanvas.runExtensions("elementRemoved", {
					elems: elems
				});
			};
...
// 					}
			...
			svgCanvas.bind("removed", elementRemoved);
